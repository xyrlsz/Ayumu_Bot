...
from Based.Config import config_data, Host
...
async def process_message():
    ...
    while True:
        ...
        tasks = [
            ...
            limited_task(sem, CapooPic, message),
            limited_task(sem, LoongPic, message),
        ]
...
def run_threaded_tasks():
    ...
    # 创建线程
    # thread1 = threading.Thread(target=check_in, args=())
